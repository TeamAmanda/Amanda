...
from Amanda import telethn as borg, HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID
from Amanda.events import register
from Amanda.function.heroku_helper import HerokuHelper
