...
4️⃣ If userbot joined enjoy music, If not add @SLBotsOfficialHelp to your group and retry
 
* 🔔 For Channel Music Play 🔔 *

1️⃣ Make @TheAmandabot  admin of your channel 
...
4) Add @TheAmandabot to the channel as an admin.
5) Simply send commands in your group.
 
* ⚫️More tools⚫️ *

• /admincache: Updates admin info of your group. Try if bot isn't recognize admin
• /userbotjoin: Invite @SLBotsOfficialHelp Userbot to your chat 
