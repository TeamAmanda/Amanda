from Amanda.config import Config
from Amanda.events import register
from Amanda import CMD_HELP
from Amanda import tbot as borg
from Amanda import tbot
from Amanda import OWNER_ID, SUDO_USERS
...
async def yufytf(event):
    ...
    file_name = "LogoBy@TheAmandabot.png"
    await event.delete()
...
async def slogo(event):
    ...
    fname2 = "LogoBy@TheAmandabot.png"
    img.save(fname2, "png")
...
LOGO_HANDLER = DisableAbleCommandHandler("logo", logo)
SLOGO_HANDLER = DisableAbleCommandHandler("slogo", slogo)
BLOGO_HANDLER = DisableAbleCommandHandler("blogo", blogo)
HLOGO_HANDLER = DisableAbleCommandHandler("hlogo", hlogo)
CLOGO_HANDLER = DisableAbleCommandHandler("clogo", "cyberlogo")
KLOGO_HANDLER = DisableAbleCommandHandler("klogo", klogo)
BONK_HANDLER = DisableAbleCommandHandler("bonk", bonk)
JLOGO_HANDLER = DisableAbleCommandHandler("jlogo", jlogo)
XLOGO_HANDLER = DisableAbleCommandHandler("xlogo", xlogo)
OKLOGO_HANDLER = DisableAbleCommandHandler("oklogo", oklogo)
GLOGO_HANDLER = DisableAbleCommandHandler("glogo", glogo)
DLOGO_HANDLER = DisableAbleCommandHandler("dlogo", dlogo)
SALALOGO_HANDLER = DisableAbleCommandHandler("salalogo", salalogo)
HINLOGO_HANDLER = DisableAbleCommandHandler("hinlogo", hinlogo)

dispatcher.add_handler(LOGO_HANDLER)
dispatcher.add_handler(SLOGO_HANDLER)
dispatcher.add_handler(BLOGO_HANDLER)
dispatcher.add_handler(HLOGO_HANDLER)
dispatcher.add_handler(CLOGO_HANDLER)
dispatcher.add_handler(KLOGO_HANDLER)
dispatcher.add_handler(BONK_HANDLER)
dispatcher.add_handler(JLOGO_HANDLER)
dispatcher.add_handler(XLOGO_HANDLER)
dispatcher.add_handler(OKLOGO_HANDLER)
dispatcher.add_handler(GLOGO_HANDLER)
dispatcher.add_handler(DLOGO_HANDLER)
dispatcher.add_handler(SALALOGO_HANDLER)
dispatcher.add_handler(HINLOGO_HANDLER)

__command_list__ = ["logo"]
__command_list__ = ["slogo"]
__command_list__ = ["blogo"]
__command_list__ = ["hlogo"]
__command_list__ = ["clogo"]
__command_list__ = ["klogo"]
__command_list__ = ["bonk"]
__command_list__ = ["jlogo"]
__command_list__ = ["xlogo"]
__command_list__ = ["oklogo"]
__command_list__ = ["glogo"]
__command_list__ = ["dlogo"]
__command_list__ = ["salalogo"]
__command_list__ = ["hinlogo"]

__handlers__ = [LOGO_HANDLER]
__handlers__ = [SLOGO_HANDLER]
__handlers__ = [BLOGO_HANDLER]
__handlers__ = [HLOGO_HANDLER]
__handlers__ = [CLOGO_HANDLER]
__handlers__ = [KLOGO_HANDLER]
__handlers__ = [BONK_HANDLER]
__handlers__ = [JLOGO_HANDLER]
__handlers__ = [XLOGO_HANDLER]
__handlers__ = [OKLOGO_HANDLER]
__handlers__ = [GLOGO_HANDLER]
__handlers__ = [DLOGO_HANDLER]
__handlers__ = [SALALOGO_HANDLER]
__handlers__ = [HINLOGO_HANDLER]
