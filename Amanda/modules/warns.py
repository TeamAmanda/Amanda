...
from Amanda import TIGERS, WOLVES, dispatcher
...
from Amanda.modules.helper_funcs.string_handling import split_quotes
from Amanda.modules.log_channel import loggable
from Amanda.modules.sql import warns_sql as sql
