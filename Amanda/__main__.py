...
from Amanda.modules.system_stats import bot_sys_stats
import Amanda.modules.sql.users_sql as sql

PM_START_TEXT = f"""
✨Hello There , I'm 𝓐𝓶𝓪𝓷𝓭𝓪
An Advanced Telegram Group Management 
...
※ You can support the project @SLBotsOfficialHelpbot
※ Supporting isnt always financial! [Youtube🔔](https://www.youtube.com/channel/UCoqH50psZdxpiSMIFZi6OFQ)
※ Those who cannot provide monetary support are welcome to help us develop the bot at @SLBotsOfficial.
"""
...
BUTTONS = (
    [
        ...
        [
            InlineKeyboardButton(
                text="🤖 Updates", url="https://t.me/TeamAmanda"
            ),
            InlineKeyboardButton(
                text="✨ Support",
                url="https://t.me/SLBotsOfficial",
            ),
        ],
        [
            InlineKeyboardButton(
                text="➕ Add Me To Your Group ➕",
                url=f"t.me/TheAmandabot?startgroup=true",
            )
        ],
    ]
)
...
def help_button(update, context):
    ...
    try:
        if mod_match:
            ...
            text = (
                "*╭──────✨Amanda✨─────〄*\n\nHere Is The Available  Help".format(
...
def Amanda_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f" @TheAmandabot - A bot to manage your groups with additional features!"
            f"\n\n Here's the basic help regarding use of @TheAmandabot."
            f"\n\n Almost all modules usage defined in the help menu, checkout by sending `/help`"
            f"\n\n Report error or bugs click the Button ",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ/ꜱ🐞", url="t.me/trtechguide"
                        ),
                        InlineKeyboardButton(
                            text="🤖 Updates", url="t.me/SLBotsOfficial"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="Donate 🤕", url="http://t.me/TheAmandabot?start=donate"
                        ),
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            f"\nCongragulations, @TheAmandabot now ready to manage your group."
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="* @TheAmandabot support chats*"
            "\nJoin Support Group/Channel",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/trtechguide"),
                    InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/SLBotsOfficial"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="aboutmanu_howto"),
        ...
        query.message.edit_text(
            text=f"* CREDITS  FOR @TheAmandabot  DEV *\n"
            f"\n Here you can find information about the bots I coded and the people who helped me create Amanda👇"
            f"\n [Visit Here To See Credits](https://t.me/TeamAmanda/3)"
